...
Standard european tax category codes can be found in https://peppo.org[OpenPeppol's, window=_blank] code list https://docs.peppol.eu/poacc/billing/3.0/codelist/UNCL5305/[Duty or tax or fee category code, window=_blank].
